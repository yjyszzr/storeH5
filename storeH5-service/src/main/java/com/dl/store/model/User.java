...
public class User {
     ...
     * 是否超级白名单
     */
    @Column(name = "is_super_white")
    private Integer isSuperWhite;
    ...
    public Integer getIsSuperWhite() {
        return isSuperWhite;
    }

    public void setIsSuperWhite(Integer isSuperWhite) {
